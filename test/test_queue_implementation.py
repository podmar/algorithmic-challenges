...
class TestRecursiveQueue(unittest.TestCase):
    def setUp(self):
        self.recursive_queue = RecursiveQueue()
        self.recursive_queue.enqueue(19)
        self.recursive_queue.enqueue(1)
        self.recursive_queue.enqueue(14)
